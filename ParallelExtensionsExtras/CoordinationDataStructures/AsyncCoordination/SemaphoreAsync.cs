...
namespace System.Threading.Async
{
    ...
    public sealed class SemaphoreAsync : IDisposable
    {
        ...
        public SemaphoreAsync(int initialCount) : this(initialCount, Int32.MaxValue) { }
        ...
        public SemaphoreAsync(int initialCount, int maxCount)
        {
