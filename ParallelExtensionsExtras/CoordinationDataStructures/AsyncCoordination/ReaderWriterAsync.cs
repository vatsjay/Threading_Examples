...
namespace System.Threading.Async
{
    ...
    public sealed class ReaderWriterAsync
    {
        ...
        public ReaderWriterAsync() { _factory = Task.Factory; }
        ...
        public ReaderWriterAsync(TaskFactory factory)
        {
